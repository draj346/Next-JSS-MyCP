 ...
 */
export default function ImageComponent(manifest: Manifest): void {
  manifest.addTemplate({
    name: 'image-template',
    id: 'image-template',
    fields: [{ name: 'Icon', displayName:'Icon or Image or Logo', type: CommonFieldTypes.Image, section: 'Content' }],
  });
}
