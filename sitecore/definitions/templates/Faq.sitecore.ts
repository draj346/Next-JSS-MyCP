 ...
 */
export default function FAQComponent(manifest: Manifest): void {
  manifest.addTemplate({
    name: 'faq-template',
    id: 'faq-template',
    fields: [
      { name: 'Name', type: CommonFieldTypes.SingleLineText, section: 'Content' },
      {
        name: 'Questions',
        type: CommonFieldTypes.ContentList,
        section: 'Content',
        source: `dataSource=/sitecore/content/${packageJson.config.appName}/Content/Guest/Question List`,
      },
    ],
    inherits: ['key-value-template'],
  });
}
