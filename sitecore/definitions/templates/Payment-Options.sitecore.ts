...
export default function BannerComponent(manifest: Manifest): void {
  manifest.addTemplate({
    ...
    id: 'payment-options-template',
    fields: [
      {
        name: 'Links',
        type: CommonFieldTypes.ContentList,
        source: `dataSource=/sitecore/content/${packageJson.config.appName}/Content/Payment Options/Links`,
        section: 'Content',
      },
    ],
    inherits: ['banner-with-subheading-template'],
  });
}
