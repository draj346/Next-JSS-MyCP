...
export default function BannerComponent(manifest: Manifest): void {
  manifest.addTemplate({
    ...
    id: 'banner-template',
    fields: [
      { name: 'Heading', type: CommonFieldTypes.RichText, section: 'Content' },
      { name: 'id', type: CommonFieldTypes.SingleLineText, section: 'Content' },
      { name: 'Description', type: CommonFieldTypes.RichText, section: 'Content' },
    ],
  });
}
