 ...
 */
export default function PhoneComponent(manifest: Manifest): void {
  manifest.addTemplate({
    name: 'phone-template',
    id: 'phone-template',
    fields: [
      { name: 'Title', type: CommonFieldTypes.SingleLineText, section: 'Content' },
      { name: 'Day', type: CommonFieldTypes.SingleLineText, section: 'Content' },
      { name: 'Time', type: CommonFieldTypes.SingleLineText, section: 'Content' },
    ],
  });
}
